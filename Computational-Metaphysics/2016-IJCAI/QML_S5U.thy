...
lemma "\<lfloor>\<^bold>\<box>\<phi> \<^bold>\<rightarrow> \<phi>\<rfloor>" sledgehammer
  by simp
lemma "\<lfloor>\<^bold>\<box>\<phi> \<^bold>\<rightarrow> \<^bold>\<diamond>\<phi>\<rfloor>" sledgehammer
  by simp
lemma "\<lfloor>\<^bold>\<box>\<phi> \<^bold>\<rightarrow> \<^bold>\<box>(\<^bold>\<box>\<phi>)\<rfloor>" sledgehammer
  by simp
