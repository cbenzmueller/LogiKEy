theory PMLinHOL_shallow_minimal_further_tests_1_alt imports PMLinHOL_shallow_minimal_tests             (* C.B., 2025 *)
begin             
...
lemma S4:   "AxT \<and>           Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F1"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
lemma KB4: "          AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F1"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
...
lemma S5:   "AxT \<and> AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F3"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
lemma S4:   "AxT \<and>           Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F3"                      nitpick sledgehammer             (*ctex*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*ctex*) (*no prf*)
lemma KB4: "          AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F3"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
...
lemma KB:   "          AxB           \<longrightarrow> \<Turnstile>\<^sup>m F4"                      nitpick sledgehammer             (*none*) (*proof*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
lemma K4:   "                    Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F4"                      nitpick sledgehammer             (*unkn*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*unkn*) (*proof*)
...
lemma S4:   "AxT \<and>           Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F5"                      nitpick sledgehammer             (*none*) (*proof*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
lemma KB4: "          AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F5"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
...
lemma KB:   "          AxB           \<longrightarrow> \<Turnstile>\<^sup>m F5"                      nitpick sledgehammer             (*ctex*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*ctex*) (*no prf*)
lemma K4:   "                    Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F5"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
lemma K:     "                                  \<Turnstile>\<^sup>m F5"                     nitpick sledgehammer             (*ctex*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*ctex*) (*no prf*)


lemma S5:   "AxT \<and> AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F6"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
lemma S4:   "AxT \<and>           Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F6"                      nitpick sledgehammer             (*ctex*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*ctex*) (*no prf*)
lemma KB4: "          AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F6"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
...
lemma S5:   "AxT \<and> AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F7"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
lemma S4:   "AxT \<and>           Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F7"                      nitpick sledgehammer             (*ctex*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*ctex*) (*no prf*)
lemma KB4: "          AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F7"                      nitpick sledgehammer             (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops    (*none*) (*proof*)
...
lemma KT:   "AxT                     \<longrightarrow> \<Turnstile>\<^sup>m F8"                      nitpick sledgehammer            (*none*) (*proof*)
                                                                      apply simp nitpick sledgehammer oops   (*none*) (*proof*)
lemma KB:   "          AxB           \<longrightarrow> \<Turnstile>\<^sup>m F8"                      nitpick sledgehammer            (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops   (*none*) (*proof*)
...
lemma S5:   "AxT \<and> AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F9"                     nitpick sledgehammer             (*none*) (*proof*)
                                                                      apply simp nitpick sledgehammer oops   (*none*) (*proof*)
lemma S4:   "AxT \<and>           Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F9"                      nitpick sledgehammer            (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops   (*none*) (*proof*)
lemma KB4: "          AxB \<and> Ax4 \<longrightarrow> \<Turnstile>\<^sup>m F9"                     nitpick sledgehammer             (*ctex*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops   (*ctex*) (*no prf*)
lemma KTB: "AxT \<and> AxB           \<longrightarrow> \<Turnstile>\<^sup>m F9"                      nitpick sledgehammer            (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops   (*none*) (*proof*)
lemma KT:   "AxT                     \<longrightarrow> \<Turnstile>\<^sup>m F9"                      nitpick sledgehammer            (*none*) (*no prf*)
                                                                      apply simp nitpick sledgehammer oops   (*none*) (*proof*)
...
\<comment>\<open>Summary of experiments: 
 ...
 Sledgehammer: proof=58 (with simp 38, without simp 20), no prf=102  (with simp 42, without simp 60) \<close>
