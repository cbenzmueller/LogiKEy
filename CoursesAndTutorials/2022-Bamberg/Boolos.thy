...
(*
lemma L1: "\<forall>X::i\<Rightarrow>bool. induct X \<longrightarrow> (\<forall>z. N z \<longrightarrow> X z)" using N_def by fastforce 
...
lemma "((\<forall>n. F n e = s e) \<and> (\<forall>y. F e (s y) = s (s (F e y))) \<and>
  ...
  sledgehammer[remote_leo2 remote_leo3 vampire cvc4 z3, overlord]()
  oops 
