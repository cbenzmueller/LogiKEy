...
lemma "idealLab AF Lab \<Longrightarrow> idealOld AF Lab" nitpick[expect=genuine] oops
(* The converse is false: idealOld is retained only as a deprecated counterexample definition. *)
