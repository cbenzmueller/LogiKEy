...
(* Inclusion relations as summary: Figure 12 of [BCG2011]
   All displayed inclusions are verified. The non-inclusion of the inverse directions has been checked
...
lemma ideal_implies_complete: \<open>idealLab\<^sup>\<A> AF Lab \<Longrightarrow> completeLab\<^sup>\<A> AF Lab\<close>
  by (rule idealLab_complete)
