%
\begin{isabellebody}%
\setisabellecontext{mere{\isacharunderscore}{\kern0pt}addition{\isacharunderscore}{\kern0pt}lewis}%
%
\isadelimdocument
%
\endisadelimdocument
...
\isatagdocument
%
\isamarkupsection{Study Mere Addition Paradox:: Lewis' rule%
}
\isamarkuptrue%
%
\endisatagdocument
...
\ {\isacharparenleft}{\kern0pt}metis\ PPP{\isadigit{0}}\ PPP{\isadigit{1}}\ PPP{\isadigit{2}}\ assms{\isacharparenright}{\kern0pt}%
\endisatagproof
{\isafoldproof}%
%
\isadelimproof
...
\ {\isacharbrackleft}{\kern0pt}satisfy{\isacharcomma}{\kern0pt}expect{\isacharequal}{\kern0pt}genuine{\isacharcomma}{\kern0pt}card\ i{\isacharequal}{\kern0pt}{\isadigit{3}}{\isacharcomma}{\kern0pt}show{\isacharunderscore}{\kern0pt}all{\isacharbrackright}{\kern0pt}\ %
...
\isatagproof
\isacommand{by}\isamarkupfalse%
\ {\isacharparenleft}{\kern0pt}metis\ PPP{\isadigit{0}}\ PPP{\isadigit{1}}\ PPP{\isadigit{2}}\ assms{\isacharparenleft}{\kern0pt}{\isadigit{1}}{\isacharparenright}{\kern0pt}\ assms{\isacharparenleft}{\kern0pt}{\isadigit{2}}{\isacharparenright}{\kern0pt}{\isacharparenright}{\kern0pt}%
\endisatagproof
{\isafoldproof}%
%
\isadelimproof
...
\end{isabellebody}%
\endinput
%:%file=~/GITHUBS/LogiKEy/Deontic-Logics/cube-ddl-afp/mere_addition_lewis.thy%:%
%:%11=1%:%
%:%23=3%:%
%:%31=5%:%
%:%32=5%:%
