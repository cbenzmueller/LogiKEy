theory GDPR_E imports Ebackup       (*GDPR CTD Example. C. Benzmüller & X. Parent, 2019*)
begin
...
(*Implicit: It is an obligation to keep the data if it was processed lawfully.*)
 A3: "\<lfloor>\<^bold>\<forall>d. \<circle><\<^bold>\<not>erase d | is_protected_by_GDPR d \<^bold>\<and> process_lawfully d>\<rfloor>" and
...
(***Some Experiments***) 
 ...
 lemma "\<lfloor>\<^bold>\<circle><kill Mary>\<rfloor>\<^sub>l" nitpick oops (*Should Mary be killed? —
